...
## Projektbeschreibung
In diesem Projekt wird der Titanic Datensatz mithilfe von R analysiert. Ziel des Projekts ist es, die Daten aufzubereiten und mithilfe geeigneter statistischer Methoden zu analysieren.
***
...
4. Diejenigen Gruppenmitglieder, die nicht an (1.) gearbeitet haben, sollen mit Hilfe
   der in (3.) in Funktionen-R-Skript 1 erstellten Funktionen den aufgeräumten
   Datensatz aus (1.) analysieren (Deskription und Visualisierung). 
   Dokumentiert anschließend eure Ergebnisse in einem kurzen Bericht, den ihr als pdf-Datei mit LaTeX erzeugt.

5. Diskutiert anschließend im GitHub Repository als ganze Gruppe die Ergebnisse.
   Möglicherweise haben die Gruppenmitglieder, die an (1.) gearbeitet haben noch weitere Ideen.
***
